...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TemporaryUser'
        db.create_table('teams_temporaryuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('email_link', self.gf('django.db.models.fields.SlugField')(max_length=128)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'])),
            ('becomes_team_captain', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('teams', ['TemporaryUser'])


    def backwards(self, orm):
        # Deleting model 'TemporaryUser'
        db.delete_table('teams_temporaryuser')
    ...
    models = {
        ...
        'teams.temporaryuser': {
            'Meta': {'object_name': 'TemporaryUser'},
            'becomes_team_captain': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'email_link': ('django.db.models.fields.SlugField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']"})
        }
    }
